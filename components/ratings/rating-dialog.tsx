...
export function RatingDialog({
  ...
  // 🔍 Debug: Log what’s coming from OfferCard
  useEffect(() => {
    console.log("🔹 Received barter in RatingDialog:", barter)
  }, [barter])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!barter.other_user_id) {
      toast({
        title: "Error",
        description: "Cannot submit rating — missing user ID.",
        variant: "destructive",
      })
      return
    }
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          <DialogTitle>Rate Your Experience</DialogTitle>
          <DialogDescription>
            How was your barter experience with {barter.other_user_name} for "
            {barter.listing_title}"?
          </DialogDescription>
        </DialogHeader>
