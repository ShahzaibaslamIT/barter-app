        ...
        <Tabs defaultValue="received" className="w-full">
          ...
          <TabsContent value="received" className="space-y-4">
            {isLoading ? (
              ...
              receivedOffers.map((offer) => (
                <OfferCard key={offer.offer_id} offer={offer} type="received" onUpdate={() => fetchOffers(localStorage.getItem("auth_token")!)} />
              ))
            )}
          </TabsContent>
          ...
          <TabsContent value="sent" className="space-y-4">
            {isLoading ? (
              ...
              sentOffers.map((offer) => (
                <OfferCard key={offer.offer_id} offer={offer} type="sent" onUpdate={() => fetchOffers(localStorage.getItem("auth_token")!)} />
              ))
            )}
          </TabsContent>
        </Tabs>
